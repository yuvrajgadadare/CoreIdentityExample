...
namespace CoreIdentityExample.Controllers
{
    public class AssessmentController : Controller
    {
        ...
        public AssessmentController(IMasterService masterService, IStudentService studentService, IOptions<EmailSettings> settings, IExamService examService, ITopicService topicService, IContentService contentService)
        {
        ...
        public async Task<IActionResult> Index(int exam_id,int student_id)
        {
          //  int branch_id = (int)HttpContext.Session.GetInt32("branch_id");
            ...
            List<ExamModel> examlist =await examService.ViewAllScheduleExams(student.branch_id);
        ...
        public async Task<JsonResult> GetCurrentExam()
        {
